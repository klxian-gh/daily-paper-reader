...
date: 2026-04-14
pdf: "https://arxiv.org/pdf/2604.12749v2"
tags: ["query:qmmm"]
score: 6.0
evidence: 预测光化学和非绝热分子动力学
tldr: 本研究总结了2023年发起的一项计算化学挑战赛，旨在预测环丁酮在200nm光激发下的光化学过程及超快电子衍射（MeV-UED）信号。来自全球的70多位研究者提交了15种预测方案，涵盖了多种电子结构和非绝热分子动力学方法。通过与SLAC和上海交大的实验数据对比，该挑战评估了当前理论模拟的预测能力，为非绝热动力学领域提供了重要的基准参考和实践策略分享。
selection_source: fresh_fetch
motivation: 旨在通过盲测挑战评估非绝热分子动力学在预测复杂光化学过程及实验观测信号方面的成熟度与准确性。
method: 组织全球研究团队采用多种电子结构理论和非绝热动力学模拟方法，在实验完成前独立预测环丁酮的光化学行为。
result: 汇总了15项理论预测结果并与两台独立MeV-UED仪器的实验数据进行了对比，展示了当前模拟方法的定性预测能力。
conclusion: 挑战证明了非绝热动力学的预测潜力，同时强调了电子结构理论对动力学结果的决定性影响，为计算光化学提供了重要的校准依据。
---

## 摘要
本篇展望是探讨非绝热分子动力学在预测光化学过程方面成熟度的专题的一部分。2023年，计算光化学界发起了一项预测挑战，旨在模拟环丁酮在200 nm光激发下的光化学过程以及由此产生的时间分辨兆电子伏特超快电子衍射（MeV-UED）信号。该挑战吸引了来自70多位研究人员的15项理论预测，他们在SLAC（美国斯坦福）进行实验之前，采用了多种电子结构和非绝热分子动力学策略来预测时间分辨MeV-UED信号。上海交通大学的MeV-UED仪器也被用于为环丁酮的光化学过程提供第二个独立的时间分辨MeV-UED信号。本篇展望讨论了参与者为预测环丁酮光化学过程所采用的各种方法和策略。本研究还总结了用于光激发、电子结构、非绝热动力学和可观测值计算的各种方法的优缺点，这些内容是参与者在2025年4月于洛桑举行的专门讨论挑战结果的CECAM研讨会上达成的共识。本篇展望还将所有预测的时间分辨MeV-UED信号与实验信号汇总在同一张图中。此次挑战（i）展示了非绝热分子动力学的定性预测能力，（ii）强调了电子结构理论对激发态动力学结果的影响，以及对其进行仔细基准测试的必要性。这一努力使学术界能够分享执行非绝热动力学的实用策略（在本展望中讨论），并构成了计算光化学的一次“校准”练习。
